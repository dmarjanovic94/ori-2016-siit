...
canvas.icons = dict()
icons = dict()
for f in os.listdir('../../02-search-board/src/robot/icons'):
    icon = Image.open(os.path.join('../../02-search-board/src/robot/icons', f))
...
# load default board
load_board('../../02-search-board/src/robot/boards/board.brd')
